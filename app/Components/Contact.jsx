    ...
    bg-[url('/footer-bg-color.png')] bg-no-repeat bg center bg-[length:90%_auto]">
      ...
      <form onSubmit={onSubmit}className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
            ...
            border-gray-400 rounded-md bg-white' name='Name' type='text' placeholder='Enter your name' required/>
            <input className='flex-1 p-3 outline-none border-[0.5px]
            border-gray-400 rounded-md bg-white' name ='Email'type='email' placeholder='Enter your email' required/>
        </div>
        <textarea name='Message' className='w-full outline-none border-[0.5px]
            border-gray-400 rounded-md bg-white w-full mb-6 p-4' rows='6' placeholder='Enter your message' required></textarea>
